...
_python_doc_base = 'http://docs.python.org'
...
intersphinx_mapping = {
    ...
    'mbuild': ('http://mbuild.readthedocs.io/en/latest/', None),
}
...
author = u'Christoph Klein, Janos Sallai'
...
latex_documents = [
  (master_doc, 'mbuild.tex', u'mbuild Documentation',
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'mbuild', u'mbuild Documentation',
     [u'Author'], 1)
]
...
texinfo_documents = [
  (master_doc, 'mbuild', u'mbuild Documentation',
   author, 'mbuild', 'One line description of project.',
   'Miscellaneous'),
]
